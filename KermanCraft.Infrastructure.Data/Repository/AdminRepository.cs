...
namespace KermanCraft.Infrastructure.Data.Repository
{
    public class AdminRepository : IAdminRepository
    {
        ...
        public AdminRepository(KermanCraftDb db, UserManager<People> userManager, RoleManager<IdentityRole> roleManager, IMapper mapper)
        {
            _db = db;
        ...
        public async Task<ResponseBase<People>> AddAdminUser(People people, string password)
        {
            try
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var response = await _userManager.AddToRoleAsync(people, "Admin");
        ...
        public async Task<ResponseBase<People>> UpdateAdminUser(People people)
        {
            try
            {
        ...
        public async Task<ResponseBase<People>> DeleteAdminUser(string id)
        {
            try
            {
        ...
        public async Task<ResponseBase<IEnumerable<People>>> GetAdminUserList()
        {
            try
            {
        ...
        public async Task<ResponseBase<People>> GetAdminUserById(string id)
        {
            try
            {
                var model = await _userManager.FindByIdAsync(id);
        ...
        public async Task<ResponseBase<bool>> IsAdminUserInRole(string userName)
        {
            try
            {
