...
namespace KermanCraft.Infrastructure.Data.Repository
{
    public class CustomerRepository:ICustomerRepository
    {
        ...
        public CustomerRepository(KermanCraftDb db, UserManager<People> userManager, RoleManager<IdentityRole> roleManager, IMapper mapper)
        {
            _db = db;
        ...
        public async Task<ResponseBase<People>> AddCustomer(People people, string password)
        {
            try
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var response = await _userManager.AddToRoleAsync(people, "Customer");
        ...
        public async Task<ResponseBase<People>> UpdateCustomer(People people)
        {
            try
            {
        ...
        public async Task<ResponseBase<People>> DeleteCustomer(string id)
        {
            try
            {
        ...
        public async Task<ResponseBase<IEnumerable<People>>> GetCustomerList()
        {
            try
            {
        ...
        public async Task<ResponseBase<People>> GetCustomerById(string id)
        {
            try
            {
                var model = await _userManager.FindByIdAsync(id);
        ...
        public async Task<ResponseBase<People>> GetCustomerByMobile(string phoneNumber)
        {
            try
            {
                var model = await _userManager.FindByNameAsync(phoneNumber);
                if (model == null)
                    return new ResponseBase<People>()
                    {
                        Message = string.Format(MessageResource.NotFound, PeopleResource.Customer),
        ...
        public async Task<ResponseBase<bool>> IsCustomerInRole(string userName)
        {
            try
            {
